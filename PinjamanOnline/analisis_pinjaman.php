  ...
  <main>
    <section>
      ...
      <table border="1" cellpadding="10" cellspacing="0">
        ...
        <tbody>
          <?php
          $sql = "SELECT * FROM view_analisis_pinjaman";
          ...
          if ($result && $result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>" . htmlspecialchars($row['total_tagihan']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['status']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['jumlah_angsuran']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['total_dibayar']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['sisa_tagihan']) . "</td>";
                  echo "</tr>";
              }
          } else {
