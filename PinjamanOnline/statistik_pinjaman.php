  ...
  <main>
    <section>
      ...
      <table border="1" cellpadding="10" cellspacing="0">
        ...
        <tbody>
          <?php
          $sql = "SELECT * FROM view_statistik_pinjaman";
          ...
          if ($result && $result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>" . htmlspecialchars($row['total_pinjaman']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['total_jumlah_pinjaman']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['rata_rata_pinjaman']) . "</td>";
                  echo "</tr>";
              }
          } else {
